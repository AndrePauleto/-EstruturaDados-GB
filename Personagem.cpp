...
bool Personagem::colisaoAtaqueInimigo(Inimigo * inimigo)
{
	return false;
}
...
int Personagem::getCodigoPersonagem()
{
	return this->codigoPersonagem;
}

int Personagem::getConsumoManaAtaque()
{
	return this->consumoManaAtaque;
}
